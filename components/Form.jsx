      ...
      >
        <label>
          ...
          <textarea
            ...
            required
            className="form_textarea placeholder-gray-300"
          />
        </label>
        <label>
          <span className="font-satoshi font-semibold text-base text-gray-50">
          ...
          <input
            ...
            required
            className="form_input placeholder-gray-300"
          />
        </label>
        ...
        <div className="flex-end mx-3 mb-5 gap-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="px-5 py-1.5 text-sm font-semibold bg-black/30 rounded-full text-gray-50"
          >
